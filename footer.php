<!-- Tombol Live Chat -->
<button type="button" class="btn btn-success rounded-circle" id="liveChatBtn" data-bs-toggle="modal" data-bs-target="#chatModal" title="Live Chat" style="position: fixed; bottom: 120px; right: 20px; z-index: 999;">
...
<style>
    ...
    background: rgba(255, 250, 240, 0.8); /* Menggunakan rgba untuk transparansi floralwhite */
...
#goTopBtn {
    ...
    background-color: rgba(176, 196, 222, 0.8); /* Warna biru abu-abu sedikit transparan */
    color: #000; /* Warna ikon */
    border: none; /* Tanpa border */
    border-radius: 50%; /* Membuat lingkaran */
    width: 50px; /* Ukuran lebar lingkaran */
    height: 50px; /* Ukuran tinggi lingkaran */
    display: flex; /* Menggunakan flexbox */
    align-items: center; /* Memusatkan ikon secara vertikal */
    justify-content: center; /* Memusatkan ikon secara horizontal */
    font-size: 20px; /* Ukuran ikon */
    transition: background-color 0.5s; /* Efek transisi saat hover */
    z-index: 1000; /* Memastikan di atas elemen lain */
}

#goTopBtn:hover {
    background-color: rgba(0, 123, 255, 0.8); /* Warna latar belakang saat hover menjadi sedikit transparan */
